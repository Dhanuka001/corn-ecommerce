  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-r from-[#0a0c14] via-[#0a0f1f] to-[#0b1028] text-white">
      <div className="relative h-[420px] w-full sm:h-[520px] lg:h-[620px]">
        ...
        <div className="absolute right-10 top-1/2 -translate-y-1/2 h-72 w-72 blur-3xl opacity-60" style={{ background: `radial-gradient(circle at center, ${hero.accent}55, transparent 60%)` }} />
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 sm:right-10 lg:right-16">
          <Image
            src={hero.image}
            alt={hero.title}
            width={920}
            height={560}
            priority
            className="relative h-[320px] w-[520px] object-contain sm:h-[380px] sm:w-[640px] lg:h-[500px] lg:w-[820px]"
          />
        </div>
      </div>
    </section>
