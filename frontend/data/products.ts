...
export const products: Product[] = [
  {
    ...
    description:
      "Rugged, ocean-ready smartwatch with dual-frequency GPS, depth tracking, and 72-hour battery life tailored for PhoneBazzar explorers.",
    highlights: [
    ...
    warranty: "3-year PhoneBazzar Elite warranty + accidental cover",
    sku: "CN-AT-ULTRA-01",
    release: "March 2025",
  },
  {
    ...
    stockStatus: "in-stock",
    description:
      "360º cinematic audio with PhoneBazzar Voice intelligence, adaptive EQ, and ambient lighting tuned for modern living rooms.",
    highlights: [
      "Spatial wave drivers",
      "PhoneBazzar Voice + Matter ready",
    ...
    specs: [
      ...
      { label: "Assistant", value: "PhoneBazzar Voice / Alexa / Google" },
    ...
    warranty: "2 years limited + 1 year PhoneBazzar Care",
    sku: "CN-LM-PRO-02",
  ...
  },
  {
    ...
    stockStatus: "limited",
    description:
      "Featherweight earbuds with adaptive ANC, dual drivers, and PhoneBazzar Spatial Audio for immersive listening anywhere.",
    highlights: [
      "Adaptive triple-mode ANC",
      "Dual hybrid drivers",
      "PhoneBazzar Spatial Audio",
      "Qi + USB-C fast case",
    ],
    specs: [
    ...
    warranty: "18 months PhoneBazzar Soundcare",
    sku: "CN-AE-PRO-07",
  ...
  },
  {
    ...
    description:
      "Whole-home console with edge AI to orchestrate PhoneBazzar sensors, cameras, and automations—privacy-first by design.",
    highlights: [
      "Edge AI scene detection",
      "Thread + Matter bridge",
      "24-hour battery backup",
      "PhoneBazzar Secure LTE failover",
    ],
    specs: [
      { label: "Processor", value: "PhoneBazzar M2 Secure Core" },
  ...
  },
  {
    ...
    stockStatus: "in-stock",
    description:
      "13-inch AMOLED tablet with PhoneBazzar Pen 2 support, 120Hz panel, and studio-grade quad speakers for creative nomads.",
    highlights: [
      "13\" 120Hz AMOLED canvas",
      "PhoneBazzar Pen 2 tilt + 4,096 pressure",
    ...
    colors: [
      ...
      { name: "PhoneBazzar Neon", value: "#ff1b1b" },
    ],
  ...
  },
  {
    ...
    stockStatus: "in-stock",
    description:
      "30,000 mAh pocket station with dual USB-C PD 140W, smart passthrough, and PhoneBazzar thermal guard for safer fast charging.",
    highlights: [
      "140W dual USB-C PD",
      "Smart passthrough UPS mode",
      "PhoneBazzar Thermal Guard 3",
      "Status OLED ring",
    ],
    specs: [
      ...
      { label: "Safety", value: "UL, CE, PhoneBazzar Thermal Guard" },
    ...
    shippingEstimate: "Ready for pickup today in all PhoneBazzar kiosks",
